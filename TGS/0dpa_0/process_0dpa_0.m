%Process the unirradiated baseline SC Cu data for the irradiated Sandia
%matrix

grat=5.4579; %Calibrated grating spacing in um +/- 1.7e-8m from 2 batches
grat_err=1.7e-8;
angles=0:5:60;
...
str_base='Cu_Sandia_2016-0dpa_0-05.50um-';
