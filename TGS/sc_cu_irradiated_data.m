...
f00=fit(SAW_angles_0dpa_0(1:floor(end/2))',SAW_speeds_0dpa_0(1:1:floor(end/2))','fourier1');
f00_neg=fit(SAW_angles_0dpa_0(floor(end/2):end)',SAW_speeds_0dpa_0(floor(end/2):end)','fourier1');
...
f92=fit(SAW_angles_92dpa(1:floor(end/2))',SAW_speeds_92dpa(1:1:floor(end/2))','fourier1');
f92_neg=fit(SAW_angles_92dpa(floor(end/2):end)',SAW_speeds_92dpa(floor(end/2):end)','fourier1');
...
f50=fit(SAW_angles_50dpa(1:floor(end/2))',SAW_speeds_50dpa(1:1:floor(end/2))','fourier1');
f50_neg=fit(SAW_angles_50dpa(floor(end/2):end)',SAW_speeds_50dpa(floor(end/2):end)','fourier1');
...
f30=fit(SAW_angles_30dpa(1:floor(end/2))',SAW_speeds_30dpa(1:1:floor(end/2))','fourier1');
f30_neg=fit(SAW_angles_30dpa(floor(end/2):end)',SAW_speeds_30dpa(floor(end/2):end)','fourier1');
...
f10=fit(SAW_angles_10dpa(1:floor(end/2))',SAW_speeds_10dpa(1:1:floor(end/2))','fourier1');
f10_neg=fit(SAW_angles_10dpa(floor(end/2):end)',SAW_speeds_10dpa(floor(end/2):end)','fourier1');
...
f05=fit(SAW_angles_05dpa_1(1:floor(end/2))',SAW_speeds_05dpa_1(1:1:floor(end/2))','fourier1');
f05_neg=fit(SAW_angles_05dpa_1(floor(end/2):end)',SAW_speeds_05dpa_1(floor(end/2):end)','fourier1');
