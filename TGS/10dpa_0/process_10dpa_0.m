%Process the 10 dpa copper SC data that was irradiated at Sandia

grat=4.7826; %Calibrated grating spacing in um +/- 1.3e-9m from 3 batches
grat_err=1.3e-9;
grat2=4.7905; %Calibrated grating spacing in um +/- 0.9e-9 from 3 batches
grat2_err=0.9e-9;
angles=0:5:60;
...
str_base='Cu_Sandia_2016-10dpa_0-04.80um-';
