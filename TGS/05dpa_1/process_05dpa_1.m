%Process the 5 dpa copper SC data that was irradiated at Sandia round 2

grat1=4.7928; %Calibrated grating spacing in um from 3 batches
grat1_err=4.3e-9;
grat2=4.7754; %Calibrated grating spacing in um from 3 batches
grat2_err=7.6e-9;
grat=4.7841; %Calibrated grating spacing from all 6 batches
grat_err=1.1e-8;
angles=0:5:60;
...
str_base='Cu_Sandia_2016-05dpa_1-04.80um-';
